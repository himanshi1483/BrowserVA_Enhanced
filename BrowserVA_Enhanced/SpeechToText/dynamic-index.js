...
function getVizData() {
    ...
    var onSuccess = function (filters) {
        ...
        $.each(filters, function (i, filter) {
           ...
           // var fieldData = filter.getAppliedValues();
            //d_arr.push(fieldData);
        ...
        for (filter of filters) {
            ...
            for (var m = 0; m < length; m++) {
                var md = data[m];
               // console.log(md);
                d_arr.push(JSON.stringify(md));
            }
            
           
        }
        //var ab = JSON.stringify(d_arr);

        console.log(d_arr);

        localStorage.setItem("FieldData", d_arr);
